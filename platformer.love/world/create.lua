...
ObjectRegistry[name].body = love.physics.newBody(World, ObjectRegistry[name].x, ObjectRegistry[name].y, bodyType)
-- shape is collusion
ObjectRegistry[name].shape = love.physics.newRectangleShape(ObjectRegistry[name].w, ObjectRegistry[name].h)
-- phyical props, 1 is density
ObjectRegistry[name].fixture = love.physics.newFixture(ObjectRegistry[name].body, ObjectRegistry[name].shape, 1 )
-- elasiticy
